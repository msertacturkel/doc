...
public class DbBean {
	public String dbUrl = "jdbc:derby://localhost:1527/myeclipse"; 
	  public String dbUserName = "classiccars"; 
	  public String dbPassword = "classiccars"; 
	  ...
	  public Hashtable getCategories() {
	    ...
	    try {
	      ...
	      System.out.println("byradayim");
	      Statement s = connection.createStatement(); 
	      String sql = "SELECT CategoryId, Category FROM App.Categories"; 
	...
	dbPassword); 
	        Statement s = connection.createStatement(); 
	        String sql = "SELECT ProductId, Name, Description, Price FROM App.Products" + 
	  ...
	  public boolean insertOrder(String contactName, String deliveryAddress, 
	    ...
	    try {
	      ...
	      Statement s = connection.createStatement(); 
	      String sql = "INSERT INTO App.Orders" + 
	      ...
	      while (enum.hasMoreElements()) {
	        ...
	        sql = "INSERT INTO App.OrderDetails (OrderId, ProductId, Quantity, Price)" + 
